...
void MatrixVectorELLomp1(int M, int N, int NNZ, int MAXNZ, const int* JA,
 const double* AZ, const double* x, double* restrict y);
void save_result_omp(int nthreads, int chunk_size,
                 double tmlt_csr_serial, double mflops_csr_serial, double max_diff_csr_serial,
                 double tmlt_ell_serial, double mflops_ell_serial, double max_diff_ell_serial,
                 ...
                 double tmlt_ell_omp1, double mflops_ell_omp1, double max_diff_ell_omp1)
{
  ...
  fprintf(fp, "%d,%d,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f,%.2f\n",
          nthreads, chunk_size, tmlt_csr_serial, mflops_csr_serial, max_diff_csr_serial,
          tmlt_ell_serial, mflops_ell_serial, max_diff_ell_serial,
          tmlt_csr_omp1, mflops_csr_omp1, max_diff_csr_omp1,
          tmlt_ell_omp1, mflops_ell_omp1, max_diff_ell_omp1);
